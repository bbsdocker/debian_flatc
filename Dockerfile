...
RUN useradd -ms /bin/bash builduser \
    ...
    && apt-get -t buster-backports install -y /home/builduser/debuild/flatbuffers-compiler_*.deb \
                                              /home/builduser/debuild/libflatbuffers1_*.deb \
    && apt-get purge -y build-essential devscripts \
